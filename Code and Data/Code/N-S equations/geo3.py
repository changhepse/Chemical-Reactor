...
plt.scatter(OUTLET[:, 0:1], OUTLET[:, 1:2], s=0.5,marker='o', alpha=1, color='green')#出口
plt.scatter(WALL[:,0:1], WALL[:,1:2],s=0.5,marker='o', alpha=1 ,color='black')#上下壁面
plt.scatter(CYLD[:,0:1], CYLD[:,1:2], s=0.5,marker='o', alpha=1 ,color='orange')#加热筒
plt.scatter(XY_c[:,0:1], XY_c[:,1:2], s=0.5,marker='o', alpha=0.3 ,color='blue')#内部域
